...
<div class="container">
    <div class="row">
        <div class="col-8">
            ...
            <form action="/sepatu/saveBeli/<?= $penjualan['id']; ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <input type="hidden" id="status_bayar" name="status_bayar" value="sudah di bayar">
                <div class="row mb-3">
                ...
                <div class="perhitungan">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-2">
                            <input type="number" class="form-control" id="jumlah_sepatu" name="jumlah_sepatu" value="<?= (old('jumlah_sepatu')) ? old('jumlah_sepatu') : $penjualan['jumlah_sepatu'] ?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="nama_sepatu" class="col-sm-3 col-form-label">Nama Sepatu</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control <?= ($validation->hasError('nama_sepatu')) ? 'is-invalid' : ''; ?>" id="nama_sepatu" name="nama_sepatu" autofocus value="<?= (old('nama_sepatu')) ? old('nama_sepatu') : $penjualan['nama_sepatu'] ?>" readonly>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9 input-group">
                            ...
                            <input type="text" class="form-control" id="harga_sepatu" name="harga_sepatu" value="<?= (old('harga_sepatu')) ? old('harga_sepatu') : $penjualan['harga_sepatu'] ?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
